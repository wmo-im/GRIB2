...
if __name__ == "__main__":
    ...
    fieldnames=["Title_en","OctetNo","OctetCount","Contents_en","Note_en","noteIDs","codeTable","flagTable","Status"]    
    csv_writer = CSVWriter("txt/Template.txt",fieldnames)
    
    xml_elements=["Title_en","OctetNo","OctetCount","Contents_en","Note_en","noteIDs","codeTable","flagTable","Status"]
